...
$stmt = $db->prepare("SELECT * FROM Recursos");
$stmt->execute();
?>
  ...
  ?>
    ...
    <div class="row">
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            echo "<div class='card' style='background-color: #f4f4f4;'>";
            echo "<div class='card-body'>";
            echo "<h5 class='card-title'>" . $row['titulo'] . "</h5>";
            echo "<p class='card-text'>" . $row['descripcion'] . "</p>";
            echo "<a href='" . $row['enlace'] . "' target='_blank' class='btn btn-primary'>Ver Recurso</a>";
            echo "</div>";
            echo "</div>";
            echo "</div>";
        }
