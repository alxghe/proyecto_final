...
<body>
    ...
    <h2 class="text-center mb-4">Lista de Especialistas</h2>
    ...
    if ($result->rowCount() > 0) {
        ...
        while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
            ...
            echo '<p class="card-text"><strong>Especialidad:</strong> ' . $row['especialidad'] . '</p>';
            echo '<p class="card-text"><strong>Contacto:</strong> ' . $row['contacto'] . '</p>';
            echo '</div>';
            echo '</div>';
            echo '</div>';
        }
