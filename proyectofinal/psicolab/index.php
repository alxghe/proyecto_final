...
?>
  ...
  <main>
    <section class="shadow" style="display: block;background-color: rgb(17, 103, 103);">
      <br>
          ...
          <div class="col mb-3">
            <div class="card h-100 shadow">
              <div class="card-body text-center" style="background-color: azure;">
                <p class="text-justify fw-bold fs-4">Historias de éxitos</p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card shadow h-100 bg-cover bg-center" style="background-color: azure;">
              ...
              <div class="card-body position-relative">
                <h5 class="card-title text-dark">Arsenal</h5>
                <p class="card-text text-dark">
                  Disfruta de la gran cantidad de armas que te ofrecemos, consigue tus VALORANT points
                  ahora para adquirir tu aspecto favorito en la tienda ahora.
                </p>
              </div>
            </div>
          </div>
    ...
    <br>
    <section class="shadow" style="background-color: rgb(42, 74, 74);">
      <br>
      <div class="container-fluid my-3">
          ...
          <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 ">
            <div class="shadow" style=" background-size: cover; position: relative;">
              ...
              <div class="bg-body" style=" position: relative; z-index: 2;">
                <h4 class="text-bg-secondary" style="color: #4a3d3d;">CUÉNTANOS TU HISTORIA</h4>
                <p class="" style="color: rgb(41, 39, 39);">Háblanos sobre todo aquello que te preocupa o molesta,
                  siempre
                  es bueno tener un lugar donde desahogarse</p>
              </div>
                ...
                <div class="carousel-inner">
                  ...
                  <div class="carousel-item active">
                    <div class="carousel-text">
                      ...
                      <p>Texto de la primera historia.</p>
                    </div>
                  </div>
                  <!-- Diapositiva 2 -->
                  <div class="carousel-item">
                    <div class="carousel-text">
                      ...
                      <p>Texto de la segunda historia.</p>
                    </div>
                  </div>
